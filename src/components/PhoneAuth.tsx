...
export function PhoneAuth({ onAuthSuccess, onBackToEmail }: PhoneAuthProps) {
  ...
  const handlePhoneSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.error('Error al enviar código SMS. Inténtalo de nuevo.');
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleVerifyCode = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.error('Error al verificar código. Inténtalo de nuevo.');
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleResendCode = async () => {
    ...
    try {
      ...
      toast.error('Error al reenviar código. Inténtalo de nuevo.');
    } finally {
      setLoading(false);
    }
  };
