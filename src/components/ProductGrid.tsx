...
export function ProductGrid() {
  ...
  // Formatear precio para móvil (números más compactos)
  const formatPrice = (price: number, isPromo = false) => {
          ...
          >
            ...
            <div className="p-2 sm:p-4">
              ...
              <div className="flex items-center text-xs sm:text-sm text-gray-600 mb-2">
                ...
                <span className="hidden sm:inline">Llega en {getShippingDays(product)} días hábiles</span>
                <span className="sm:hidden">{getShippingDays(product)} días</span>
              </div>
              ...
              <div className="flex justify-between items-center">
                <div className="flex flex-col flex-1 min-w-0">
                  {product.promotion ? (
                    <>
                      ...
                      <span className="text-sm sm:text-lg font-bold text-red-600 truncate">
                        {formatPrice(getPromotionalPrice(product) || product.price, true)}
                      </span>
                      {getPromotionLabel(product) && (
                        <div className="inline-flex items-center px-1 sm:px-2 py-1 rounded-full text-xs font-medium bg-red-100 text-red-800 w-fit">
                ...
                <div className="flex space-x-1 sm:space-x-2 ml-2">
                  <button
                    ...
                    className="p-1 sm:p-2 text-indigo-600 hover:bg-indigo-50 rounded-full transition-colors"
                  ...
                  <button
                    ...
                    className="px-2 py-1 sm:px-4 sm:py-2 bg-indigo-600 text-white rounded-md hover:bg-indigo-700 transition-colors text-xs sm:text-sm"
                  >
                    Comprar
                  </button>
                </div>
