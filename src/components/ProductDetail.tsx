...
import { ArrowLeft, FileText, Share2, Tag, Clock, Download } from 'lucide-react';
          ...
          <div className="mt-10 px-4 sm:px-0 sm:mt-16 lg:mt-0">
            ...
            {product.instructions_file && (
              <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                <div className="flex items-center space-x-3">
                  ...
                  <div className="flex-1">
                    <h4 className="text-sm font-medium text-blue-900">
                      Manual del producto disponible
                    </h4>
                    <p className="text-sm text-blue-700">
                      Descarga las instrucciones de uso y documentación del producto
                    </p>
                  </div>
                  <div className="flex-shrink-0">
                    <a
                      href={product.instructions_file}
                      download={`manual-${product.name}.pdf`}
                ...
                {/* Botón alternativo para ver en línea */}
