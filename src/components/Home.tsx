...
import { usePWA, useDeviceType, useOnlineStatus } from '../hooks/usePWA';
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-2 sm:px-4 lg:px-8">
          <div className="flex justify-between h-16">
            ...
            <div className="flex items-center space-x-2 sm:space-x-4">
              ...
              {/* Botón PWA Install - solo visible si es instalable */}
              {isInstallable && deviceType === 'mobile' && (
                <button
                  onClick={install}
                  className="hidden sm:flex items-center px-3 py-1 bg-indigo-100 text-indigo-700 rounded-full text-sm hover:bg-indigo-200 transition-colors"
                >
                  Instalar App
                </button>
              )}
              ...
              <div className="hidden lg:flex items-center space-x-4">
                ...
                <button
                  ...
                  className="flex items-center text-gray-700 hover:text-red-600 relative transition-colors"
                >
              ...
              {/* Navegación móvil */}
              <MobileNavigation onAuthRequired={() => setShowAuthModal(true)} />
            </div>
          </div>
        </div>
      </nav>
      ...
      <BottomNavigation onAuthRequired={() => setShowAuthModal(true)} />
    </div>
  );
}
